(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&l(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const de={MJ:1,kJ:.001,kcal:.004186,kWh:3.6},u={hp:{cop:3,opex:2.5},electric:{price:.7,calorific:3.6,factor:.57,boilerEff:98,opex:.4,capex:50},gas:{price:4.2,calorific:36,factor:1.97,boilerEff:92,opex:1.8,capex:80},coal:{price:1e3,calorific:21,factor:2.42,boilerEff:80,opex:6.8,capex:60},fuel:{price:8e3,calorific:42,factor:3.1,boilerEff:90,opex:1.9,capex:70},biomass:{price:850,calorific:15,factor:0,boilerEff:85,opex:6.3,capex:75},steam:{price:280,calorific:2.8,factor:.35,boilerEff:95,opex:0,capex:0}},pe={water:{mass:100,tempIn:15,tempOut:60},steam:{mass:10,pressure:.8,feedTemp:20}};function $(e,t=2){const s=parseFloat(e);return isNaN(s)?"-":(s/1e4).toLocaleString("zh-CN",{minimumFractionDigits:t,maximumFractionDigits:t})}function q(e,t=2){const s=parseFloat(e);return isNaN(s)?"-":s.toLocaleString("zh-CN",{minimumFractionDigits:t,maximumFractionDigits:t})}function X(e,t=2){const s=parseFloat(e);return isNaN(s)?"-":s.toLocaleString("zh-CN",{minimumFractionDigits:t,maximumFractionDigits:t})}function _(e,t=1){const s=parseFloat(e);return isNaN(s)?"-":(s*100).toFixed(t)+"%"}function ue(e,t,s,l,n){if(!t||!s)return{error:"请输入有效的燃料消耗量和热值"};const a=t*s/1e3;let r=0;if(l==="water"){const{mass:i,tempIn:d,tempOut:c}=n;if(!i||d===void 0||!c)return{error:"请输入完整的热水参数"};const g=c-d;r=4.186*(i*1e3)*g/1e6}else if(l==="steam"){const{mass:i,pressure:d,feedTemp:c}=n;if(!i||!d||c===void 0)return{error:"请输入完整的蒸汽参数"};const g=2770,x=4.186*c;r=i*1e3*(g-x)/1e6}return a<=0?{error:"计算得出的投入能量无效"}:{efficiency:r/a*100,inputEnergy:a,outputEnergy:r,error:null}}const G={activeTab:"charts"};function me(){ge(),be(),ye(),K(G.activeTab)}function ge(){document.querySelectorAll(".accordion-header").forEach(t=>{t.addEventListener("click",()=>{const s=t.getAttribute("aria-controls"),l=document.getElementById(s),n=t.getAttribute("aria-expanded")==="true";fe(t,l,!n)})})}function fe(e,t,s){!e||!t||(s?(t.classList.remove("hidden"),requestAnimationFrame(()=>{t.classList.add("open"),e.setAttribute("aria-expanded","true")})):(t.classList.remove("open"),e.setAttribute("aria-expanded","false"),setTimeout(()=>{e.getAttribute("aria-expanded")==="false"&&t.classList.add("hidden")},300)))}function be(){document.querySelectorAll(".tab-link").forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const l=t.dataset.tab;l&&K(l)})})}function K(e){document.querySelectorAll(".tab-link").forEach(t=>{t.dataset.tab===e?t.classList.add("tab-active"):t.classList.remove("tab-active")}),document.querySelectorAll(".tab-content").forEach(t=>{t.id===`tab-${e}`?(t.classList.remove("hidden"),xe(t)):t.classList.add("hidden")}),G.activeTab=e}function xe(e){e.querySelectorAll("canvas").forEach(s=>{window.dispatchEvent(new Event("resize"))})}function ye(){const e=document.getElementById("input-sidebar"),t=document.getElementById("mobile-open-config"),s=document.getElementById("mobile-sidebar-close"),l=document.getElementById("calculateBtn");if(!e)return;const n=a=>{a?(e.classList.remove("translate-y-full"),e.classList.add("translate-y-0"),document.body.style.overflow="hidden"):(e.classList.remove("translate-y-0"),e.classList.add("translate-y-full"),document.body.style.overflow="")};t&&t.addEventListener("click",()=>n(!0)),s&&s.addEventListener("click",()=>n(!1)),l&&l.addEventListener("click",()=>{window.innerWidth<768&&(n(!1),setTimeout(()=>oe(),300))})}function he(e){const t=document.getElementById("export-report-btn");t&&(t.disabled=!1,t.classList.remove("opacity-50","cursor-not-allowed"),t.classList.add("hover:bg-blue-700","shadow-md"))}function oe(){const e=document.getElementById("main-results-area");e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),window.scrollTo({top:0,behavior:"smooth"}))}function ve(){const e=document.getElementById("report-placeholder"),t=document.getElementById("report-content");e&&e.classList.add("hidden"),t&&t.classList.remove("hidden"),K(G.activeTab)}function O(e,t,s=null){const l=document.getElementById(`card-${e}`);l&&(l.textContent=t,s&&(l.className=l.className.replace(/text-(green|yellow|red|gray)-\d+/,""),l.classList.add(...s.split(" "))))}const M=window.innerWidth<768,se=M?11:16,Ee=M?12:18,we=M?14:20;Chart.defaults.font.family="'Inter', 'Noto Sans SC', sans-serif";Chart.defaults.font.size=se;Chart.defaults.color="#475569";Chart.defaults.scale.grid.color="#e2e8f0";Chart.defaults.scale.grid.lineWidth=1;Chart.defaults.plugins.legend.labels.font={size:Ee,weight:"bold"};Chart.defaults.plugins.legend.labels.boxWidth=M?12:20;Chart.defaults.plugins.legend.labels.padding=M?10:25;Chart.defaults.plugins.tooltip.backgroundColor="rgba(15, 23, 42, 0.95)";Chart.defaults.plugins.tooltip.titleFont={size:we,weight:"bold"};Chart.defaults.plugins.tooltip.bodyFont={size:se};Chart.defaults.plugins.tooltip.padding=12;Chart.defaults.plugins.tooltip.cornerRadius=8;const k={hp:{fill:"rgba(37, 99, 235, 0.9)"},gas:{fill:"rgba(234, 88, 12, 0.9)"},fuel:{fill:"rgba(220, 38, 38, 0.9)"},coal:{fill:"rgba(71, 85, 105, 0.9)"},biomass:{fill:"rgba(22, 163, 74, 0.9)"},electric:{fill:"rgba(147, 51, 234, 0.9)"},steam:{fill:"rgba(8, 145, 178, 0.9)"},opex:"#f59e0b"};let w={cost:null,lcc:null};function Ce(){w.cost&&(w.cost.destroy(),w.cost=null),w.lcc&&(w.lcc.destroy(),w.lcc=null)}function Be(e,t,s,l){const n=r=>{if(!r)return"#cbd5e1";const o=r.toLowerCase();return o.includes("热泵")||o.includes("hp")?k.hp.fill:o.includes("气")||o.includes("gas")?k.gas.fill:o.includes("油")||o.includes("fuel")||o.includes("oil")?k.fuel.fill:o.includes("煤")||o.includes("coal")?k.coal.fill:o.includes("生物")||o.includes("bio")?k.biomass.fill:o.includes("电")||o.includes("elec")?k.electric.fill:o.includes("蒸汽")||o.includes("steam")?k.steam.fill:"#9ca3af"},a=t.map(r=>n(r));return w.cost=new Chart(e,{type:"bar",data:{labels:t,datasets:[{label:"能源成本",data:s,backgroundColor:a,borderRadius:4,stack:"Stack 0",barPercentage:.6},{label:"运维成本",data:l,backgroundColor:k.opex,borderRadius:4,stack:"Stack 0",barPercentage:.6}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{position:"top",align:"end"},tooltip:{callbacks:{label:r=>{let o=r.dataset.label||"";return o&&(o+=": "),r.parsed.y!==null&&(o+=parseFloat(r.parsed.y).toFixed(2)+" 万"),o},footer:r=>{let o=0;return r.forEach(function(i){o+=i.parsed.y}),"总计: "+o.toFixed(2)+" 万"}}}},scales:{y:{beginAtZero:!0,title:{display:!M,text:"万元/年",font:{size:14,weight:"bold"}},stacked:!0,border:{display:!1},ticks:{padding:10}},x:{stacked:!0,grid:{display:!1},ticks:{font:{weight:"bold"},maxRotation:45,minRotation:0}}}}}),w.cost}function $e(e,t){const s=t.map(l=>Math.abs(l));return w.lcc=new Chart(e,{type:"doughnut",data:{labels:["初始投资","全周期能源","全周期运维","残值回收"],datasets:[{data:s,backgroundColor:["#ef4444","#3b82f6","#f59e0b","#10b981"],borderWidth:0,hoverOffset:15}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"60%",plugins:{legend:{position:"right",labels:{padding:20}},tooltip:{callbacks:{label:l=>{const n=l.raw,a=l.chart._metasets[l.datasetIndex].total,r=(n/a*100).toFixed(1)+"%",o=l.label;return o==="残值回收"?` ${o}: -${n.toFixed(1)} 万 (${r})`:` ${o}: ${n.toFixed(1)} 万 (${r})`}}}}}}),w.lcc}let V=null;const p=e=>`value="${e}" data-default="${e}"`,Q={MJ:1,kJ:.001,kcal:.004186,kWh:3.6},f="w-full px-3 md:px-4 py-2 bg-white border border-gray-300 rounded-lg text-base md:text-lg font-bold text-gray-900 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition-all outline-none placeholder-gray-400 h-10 md:h-12 shadow-sm",m="block text-sm font-bold text-gray-600 mb-1 md:mb-2 tracking-wide",ke="bg-white p-1 mb-4 md:mb-6";function Ie(){return`
        ...
        <div id="input-group-load" class="space-y-4 md:space-y-6 mt-4 md:mt-6">
            <div>
                ...
                <input type="number" id="heatingLoad" ${p("1000")} class="${f}" data-validation="isPositive">
            </div>
        </div>
        ...
        <div id="input-group-hours-a" class="space-y-4 md:space-y-6 mt-4 md:mt-6">
            <div>
                ...
                <input type="number" id="operatingHours" ${p("2000")} class="${f}" data-validation="isPositive">
            </div>
        </div>
        ...
        <div id="input-group-total" class="space-y-4 md:space-y-6 mt-4 md:mt-6 hidden">
            <div>
                ...
                <input type="number" id="annualHeating" ${p("2000000")} class="${f}" data-validation="isPositive">
            </div>
            <div>
                <label class="${m}">年运行小时 (反推)</label>
                <input type="number" id="operatingHours_B" ${p("2000")} class="${f}" placeholder="自动计算">
            </div>
        </div>
        ...
        <div id="input-group-daily" class="space-y-4 md:space-y-6 mt-4 md:mt-6 hidden">
            <div class="grid grid-cols-2 gap-3 md:gap-4">
                <div>
                    ...
                    <input type="number" id="dailyHours" ${p("8")} class="${f}">
                </div>
                <div>
                    <label class="${m}">年天数 (d)</label>
                    <input type="number" id="annualDays" ${p("300")} class="${f}">
                </div>
            </div>
            <div>
                <label class="${m}">平均负荷率 (%)</label>
                <input type="number" id="loadFactor" ${p("70")} class="${f}">
            </div>
        </div>
    `}function Le(){return`
        ...
        <div class="grid grid-cols-2 gap-3 md:gap-4 mb-6 md:mb-8">
            <div>
                ...
                <input type="number" id="hpCapex" ${p(u.hp.capex||"200")} class="${f}" data-validation="isPositive">
            </div>
            <div>
                <label class="${m}">储能投资 (万)</label>
                <input type="number" id="storageCapex" ${p("0")} class="${f}">
            </div>
        </div>
        <div class="pt-4 md:pt-6 border-t border-gray-200">
    ...
    `}function Se(){return`
        <div>
            ...
            <input type="number" id="hpCop" ${p(u.hp.cop)} step="0.1" class="${f} !text-xl md:!text-2xl !text-blue-700" data-validation="isStrictlyPositive">
        </div>
        ...
        <div class="pt-4 md:pt-6 border-t border-dashed border-gray-200 space-y-4 md:space-y-6">
             ...
             <div class="grid grid-cols-2 gap-3 md:gap-4">
                 <div class="related-to-gas"><label class="${m}">气价 (元/m³)</label><input type="number" id="gasPrice" ${p(u.gas.price)} class="${f}"></div>
                 <div class="related-to-coal"><label class="${m}">煤价 (元/t)</label><input type="number" id="coalPrice" ${p(u.coal.price)} class="${f}"></div>
                 <div class="related-to-steam"><label class="${m}">汽价 (元/t)</label><input type="number" id="steamPrice" ${p(u.steam.price)} class="${f}"></div>
                 <div class="related-to-fuel"><label class="${m}">油价 (元/t)</label><input type="number" id="fuelPrice" ${p(u.fuel.price)} class="${f}"></div>
                 <div class="related-to-biomass"><label class="${m}">生物质 (元/t)</label><input type="number" id="biomassPrice" ${p(u.biomass.price)} class="${f}"></div>
             </div>
        </div>
        ...
        <div class="pt-4 md:pt-6 border-t border-dashed border-gray-200">
            ...
            <div class="space-y-2 md:space-y-3">
                ${[{id:"gas",label:"气",val:u.gas.boilerEff,hasBtn:!0},{id:"coal",label:"煤",val:u.coal.boilerEff,hasBtn:!0},{id:"electric",label:"电",val:u.electric.boilerEff,hasBtn:!1},{id:"steam",label:"汽",val:u.steam.boilerEff,hasBtn:!1},{id:"fuel",label:"油",val:u.fuel.boilerEff,hasBtn:!0},{id:"biomass",label:"生物",val:u.biomass.boilerEff,hasBtn:!0}].map(e=>`
                    <div class="flex items-center gap-2 related-to-${e.id}">
                        <span class="text-sm md:text-base font-bold text-gray-600 w-10 md:w-14 shrink-0 text-right pr-2">${e.label}</span>
        ...
        <div class="mt-8 pt-4 border-t border-gray-200 text-center pb-24">
            ...
            <p class="text-[10px] text-gray-400 mt-2 leading-tight px-4">免责声明：本工具计算结果仅供参考，不作为最终投资决策依据。</p>
        </div>
    `}function Fe(){return`
        <div class="space-y-4 md:space-y-6">
            <div>
                <label class="${m}">分析年限 (年)</label>
                <input type="number" id="lccYears" ${p("15")} class="${f}">
            </div>
            <div>
                <label class="${m}">折现率 (%)</label>
                <input type="number" id="discountRate" ${p("8")} class="${f}">
            </div>
            <div class="grid grid-cols-2 gap-3 md:gap-4">
                <div>
                    <label class="${m}">能源涨幅(%)</label>
                    <input type="number" id="energyInflationRate" ${p("3")} class="${f}">
                </div>
                <div>
                    <label class="${m}">运维涨幅(%)</label>
                    <input type="number" id="opexInflationRate" ${p("5")} class="${f}">
                </div>
            </div>
            <div class="h-20 md:hidden"></div>
        </div>
    `}function Te(e){U("accordion-project","1. 项目与负荷",Ie()),U("accordion-scheme","2. 方案与投资",Le()),U("accordion-operating","3. 运行参数",Se()),U("accordion-financial","4. 财务模型",Fe()),me(),Oe(),Pe(),ne();const t=document.getElementById("calculateBtn");t&&t.addEventListener("click",()=>{Re(),e()}),Me("heatingLoadUnit","heatingLoad"),document.querySelectorAll('input[name="calcMode"]').forEach(o=>o.addEventListener("change",te)),te(),document.querySelectorAll(".comparison-toggle").forEach(o=>o.addEventListener("change",ae)),ae();const n=document.getElementById("addPriceTierBtn");n&&n.addEventListener("click",()=>{ee(),e()}),ee("平均电价",u.electric.price,"100"),He(),Ne();const a=document.getElementById("btn-reset-params");a&&a.addEventListener("click",Ae);const r=document.getElementById("enableScenarioComparison");r&&(r.addEventListener("change",()=>{const o=document.getElementById("saveScenarioBtn"),i=document.querySelector('.tab-link[data-tab="scenarios"]');r.checked?(o&&o.classList.remove("hidden"),i&&i.classList.remove("hidden")):(o&&o.classList.add("hidden"),i&&i.classList.add("hidden"))}),r.dispatchEvent(new Event("change"))),window.updateSimplePriceTier=function(o){}}function Re(){let e=parseInt(localStorage.getItem("heat_pump_usage_count")||"0");e++,localStorage.setItem("heat_pump_usage_count",e),ne(e)}function ne(e=null){e===null&&(e=parseInt(localStorage.getItem("heat_pump_usage_count")||"0"));const t=document.getElementById("usage-counter");t&&(t.textContent=`累计运行：${e} 次`)}function Pe(){document.querySelectorAll(".unit-converter").forEach(e=>{e.dataset.prevUnit=e.value,e.addEventListener("change",t=>{const s=e.dataset.targetInput,l=document.getElementById(s),n=e.value,a=e.dataset.prevUnit;if(l&&l.value){const r=parseFloat(l.value),o=Q[a],i=Q[n];if(o&&i){const d=r*(o/i);l.value=parseFloat(d.toPrecision(5)),l.classList.add("text-blue-600","font-bold"),l.classList.remove("text-gray-900")}}e.dataset.prevUnit=n})})}function Oe(){document.querySelectorAll("input[data-default], select[data-default]").forEach(e=>{e.addEventListener("input",()=>{if(e.type==="checkbox")return;e.value!=e.dataset.default?(e.classList.add("text-blue-600","border-blue-500"),e.classList.remove("text-gray-900","border-gray-300")):(e.classList.remove("text-blue-600","border-blue-500"),e.classList.add("text-gray-900","border-gray-300"))})})}function ee(e="",t="",s=""){const l=document.getElementById("priceTiersContainer");if(!l)return;const n=document.createElement("div");n.className="price-tier-entry flex gap-2 items-center mb-2",n.innerHTML=`
                ...
                <table class="min-w-full text-base md:text-lg text-left text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="bg-blue-50/50 border-b border-gray-100 font-bold text-gray-900">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-right">${$(e.hp.annualTotalCost)}</td>
                            <td class="px-4 py-4 whitespace-nowrap text-right">-</td>
                            <td class="px-4 py-4 whitespace-nowrap text-center">-</td>
                            <td class="px-4 py-4 whitespace-nowrap text-center">-</td>
                            <td class="px-4 py-4 whitespace-nowrap text-right hidden lg:table-cell">${$(e.hp.lcc.total)}</td>
                        ...
                        <tr class="bg-white hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-right font-medium">${$(a.annualTotalCost)}</td>
                            <td class="px-4 py-4 whitespace-nowrap text-right font-bold text-green-600">${$(a.annualSaving)}</td>
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-right font-medium hidden lg:table-cell">${$(a.lccTotal)}</td>
        ...
        `);const n=document.getElementById("tab-conclusion");if(n&&t){const a=t.irr>.08;n.innerHTML=`
            <div class="p-6 md:p-8 ${a?"bg-green-50 border border-green-200":"bg-yellow-50 border border-yellow-200"} rounded-2xl">
                ...
                <p class="text-lg md:text-xl text-gray-700 leading-relaxed font-medium">
                    相比于 <strong>${t.name}</strong>，工业热泵方案预计每年可节省 <strong>${$(t.annualSaving)} 万元</strong>，综合费用节能率达 <strong>${_(t.savingRate)}</strong>。
                    <br><br>
                    您的热泵供热成本相当于 <strong>${q(e.hp.unitSteamCost,1)} 元/吨蒸汽</strong>，而${t.name}的成本为 <strong>${q(t.unitSteamCost,1)} 元/吨</strong>。
                    <br><br>
                    全生命周期（${e.inputs.lccYears}年）累计节省 <strong>${$(t.lccSaving)} 万元</strong>。动态回收期为 ${t.dynamicPBP} 年。
                </p>
            </div>
